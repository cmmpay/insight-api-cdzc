...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\CryptoDezireCash\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/CryptoDezireCash/';
  if (isLinux) dataDir = process.env.HOME + '/.cryptodezirecash/';
}
